...
CONFIG=${DDPO_CONFIG:-compressibility_a100}
RUN_NAME=${DDPO_RUN_NAME:-ls6_a100_${CONFIG}_$(date +%Y.%m.%d_%H.%M.%S)}

echo "=== DDPO LS6 A100 Launch ==="
echo "Config:   $CONFIG"
...
$CONDA/accelerate launch --num_processes 3 --mixed_precision fp16 \
    scripts/train.py \
